      ...
      <div className="max-w-[500px] mx-auto">
        ...
        <div className="flex gap-6 ">
          ...
          <p>
            ...
            <span className="text-[#FF1616]">Wicked Terms of Service</span>, including the{" "}
            <span className="text-[#FF1616]">User Agreement</span> and <span className="text-[#FF1616]">Privacy Policy</span>
          </p>
        </div>
      </div>
    </div>
